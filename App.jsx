...
I had no access to a PC until I was 17 years old. At that time, I passed my exams to enter a university. Within a year after a PC appeared in my household, curiosity pushed me to start my programming experiments. I learned C++ and Java, writing small apps for Windows and JavaME (smartphones were not widely used yet). Each of my projects was a challenge, I went step by step from easy things to more complicated ones, so I was forced to resolve lots of minor problems on my way to my major goal. The lack of an academic approach is compensated with my thirst for knowledge and close attention to details. Diving deeply into a problem, discovering all and every aspect of it, lead to comprehensive knowledge of the problem.
